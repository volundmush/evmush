...
from evmush.typeclasses.mushbase import MushBase


class BaseAccount(MushBase):
    meta_type = 'ACCOUNT'
    meta_letter = 'A'


class Account(DefaultAccount, BaseAccount):
    """
...
class Guest(DefaultGuest, BaseAccount):
    """
